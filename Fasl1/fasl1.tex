...
شیمی‌دان‌ها با \censor{نمیدونم} مواد و انجام \censor{نمیدونم} (استفاده از هر ۵\censor{نمیدونم}) آن‌ها را دقیق برسی می‌کنند.
(آزمایش $\equiv$ \censor{نمیدونم} کنترل شده)
...
جدول دوره‌ای، شامل \censor{نمیدونم} دوره، و \censor{نمیدونم} گروه است. عنصر‌های جدول، بر اساس «\censor{نمیدونم}» شان در ۳ دسته \censor{نمیدونم} ، \censor{نمیدونم} و \censor{نمیدونم} \censor{نمیدونم} قرار می‌گیرند.
\end{document}
