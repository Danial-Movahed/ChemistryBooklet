...
\\
$C_{H_2O} = \dfrac{\quad J}{\quad K (\quad J.K^{-1})}\bigcirc C_{il.oil} = \dfrac{\quad J}{\quad k (\quad J.k^{-1})}$
...
\begin{flushleft}
	$Q = mc\Delta\theta\rightarrow c = \dfrac{Q}{m\Delta\theta}\downarrow$\\
	$C_{H_2O}=\dfrac{\quad}{\quad}=\censor{نمیدونم} ( \quad\quad )\quad C_{ol.oil}=\dfrac{\quad}{\quad}=\censor{نمیدونم} (\quad\quad)$
...
\begin{en}
	...
	$xKj = \qquad g \times \dfrac{\qquad mol}{\qquad g}\times\dfrac{\qquad KJ}{\qquad mol}=\censor{نمم} KJ$
...
تولید گاز‌های \censor{نمیدونم} به ویژه \censor{نمیدونم} که سهم تولید این گاز در \censor{نمیدونم} غذا،
\end{document}
