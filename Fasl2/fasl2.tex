...
\end{flushleft}
\lin
خود را بیازمایید \underline{۲} صفحه \underline{۷۳و۷۴}: الف) ارزش سوختی: اتان $\bigcirc$ اتانول \qquad\qquadآنتالپی سوختن: اتان $\bigcirc$ اتانول
\begin{flushleft}
	12C=, 1H=, 16O=
\end{flushleft}
\lin
...
خود را بیازمایید صفحه ۹۳: خرید به اندازه نیاز $\bigcirc$ / کاهش مصرف گوشت و لبنیات $\bigcirc$ / استفاده از غذا‌های بومی فصلی $\bigcirc$ / کاهش مصرف غذا‌های فرآوری شده $\bigcirc$
\circled{1}
کاهش مصرف انرژی /
\circled{2}
